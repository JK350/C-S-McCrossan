<?php
  ...
  switch($pageName)
  {
    case "index":
      ...
      break;
    case "it":
      $menuOne = array("Support Request", "Software", "Documentation", "Tech Support", "Resources", "Inventory");
      $menuTwo = array("IT Two Menu One", "IT Two Menu Two", "IT Two Menu Three", "IT Two Menu Four", "IT Two Menu Five", "IT Two Menu Six");
      $menuThree = array("IT Three Menu One", "IT Three Menu Two", "IT Three Menu Three", "IT Three Menu Four", "IT Three Menu Five", "IT Three Menu Six");
      $menuFour = array("IT Four Menu One", "IT Four Menu Two", "IT Four Menu Three", "IT Four Menu Four", "IT Four Menu Five", "IT Four Menu Six");
      $menuFive = array("IT Five Menu One", "IT Five Menu Two", "IT Five Menu Three", "IT Five Menu Four", "IT Five Menu Five", "IT Five Menu Six");
      $menuSix = array("Workstations", "Laptops", "Printers", "Servers", "Accessories");
      break;
    case "projects":
